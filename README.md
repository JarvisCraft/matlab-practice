...
2. Создаю файл `task_2_2.m` и описываю в нём исходную программу отрисовки графика функции:
...
fprintf('Абсолютная погрешность по правилу Рунге: %f\n', D);
fprintf('Относительная погрешность по правилу Рунге: %f\n', abs(D / I0));
...
Абсолютная погрешность по правилу Рунге: 0.000001
Относительная погрешность по правилу Рунге: 0.000002
Абсолютная погрешность: 1.503700e-06
Относительная погрешность: 1.786990e-06
```

Как видно, результаты соответствуют правилу Рунге и, действительно, не превышают его погрешность. Более того, действительные погрешности на несколько порядок 
...
Как можно наблюдать, обе стандартные функции дают результаты, совпадающие с результатами, полученным за счёт реализации аналогичных функций, причём это свойство сохраняется даже при высоких точностях.
